...
if($result){
  ...
  echo '<h2 align=center><u>Travel Form</u></h2>';
  ...
  while($row=mysqli_fetch_assoc($result)){
    ...
    echo '<td>
          <a href="travelupdate.php?updatesno='.$sno.'"><input type="login" value="Update"></a>
          <a href="traveldelete.php?deletesno='.$sno.'"><input type="submit" value="Delete"></a>
          </td>';
  }

  echo '<tr><th colspan="14"><a href="travel form.html">Back to Form</a></th></tr>';
  echo '</table>';
