...
if($result){
  ...
  echo '<h2 align=center><u>Feedback Form</u></h2>';
  ...
  while($row=mysqli_fetch_assoc($result)){
    ...
    echo '<td>'.$email.'</td>';
    echo '<td>
          <a href="contactdelete.php?deletesno='.$sno.'"><input type="submit" value="Delete"></a>
          </td>';
  }

  echo '<tr><th colspan="14"><a href="contact.html">Back to Form</a></th></tr>';
  echo '</table>';
